...
class Portal(game: ToddGame, sprite: MySprite, position: Vector2, radius: Float,
             private val teleportTo: Vector2, private val teleportDelay: Float) :
        PassiveObject(game, sprite, RealBodyWrapper(CircleBodyPattern(BodyDef.BodyType.StaticBody, radius, position))) {
